...
<head>
    ...
    <title>Library & Social App</title>
                                ...
                                <div class="post-content">
                                    <?php if (isset($_POST["editView"]) && $_POST["editView"] == $post['id']): ?>
                                        <form action="/post/edit" method="POST" class="post-form">
                                            ...
                                            <input type="text" name="title" value="<?= html_entity_decode(htmlspecialchars($post['title'])) ?>">
                                            <textarea name="content" class="post-content-textarea"><?= html_entity_decode(htmlspecialchars($post['content'])) ?></textarea>
